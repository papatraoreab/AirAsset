...
namespace AirAsset.Controllers
{
    public class SuivisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "suiviID,suivi")] Suivi suivi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "suiviID,suivi")] Suivi suivi)
        {
            if (ModelState.IsValid)
            {
